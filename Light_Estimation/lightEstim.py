### code for obtaining light estimation output ###
...
BASE_URL = "https://drive.google.com/drive/folders/1K0ZYIoQiDrLKUL2zqQr_P_UEzNe7G8lg"
...
def set_datapath(path):
  ...
  basedir = path
  return basedir
set_datapath('/content/drive/MyDrive/Munim/multi_illumination-master/multi_illumination_test_mip2_jpg')
...
def ensure_checkpoint_downloaded(cp):
  ...
  url = "https://drive.google.com/drive/folders/1K0ZYIoQiDrLKUL2zqQr_P_UEzNe7G8lg" % cp
...
def demo_multi_illumination():
  ...
  scenes = ['14n_office1', '14n_office10', '14n_office11']
...
def demo_materials():
  ...
  print("=== Material Demo ===")
  M = query_materials('14n_office1', mip=4)
  print(M.shape)
  plt.subplot(121)
  plt.imshow(M[0])

  M = query_materials('14n_office1', mip=4, apply_colors=True)
  print(M.shape)
  plt.subplot(122)
  plt.imshow(M[0])
  plt.show()

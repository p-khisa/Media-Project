...
class DirectoryDataset(Dataset):
    def __init__(self, data_root_path, data_extensions, load_fn, preprocess):
        data_root_path ='/content/drive/MyDrive/Munim/multi_illumination-master/multi_illumination_test_mip2_jpg'
